...
#CREATIONS
expressionMenu.addCommand('Creations/Random/Random Colors NST', "nuke.nodePaste(\"" + os.path.join(NST_FolderPath + "/nk_files/Random_colors.nk") + "\")")
expressionMenu.addCommand('Creations/Random/Random every Frame NST', "nuke.nodePaste(\"" + os.path.join(NST_FolderPath + "/nk_files/Random_every_frame.nk") + "\")")
expressionMenu.addCommand('Creations/Random/Random every Pixel NST', "nuke.nodePaste(\"" + os.path.join(NST_FolderPath + "/nk_files/Random_every_pixel.nk") + "\")")
expressionMenu.addCommand('Creations/Noise/Noise NST', "nuke.nodePaste(\"" + os.path.join(NST_FolderPath + "/nk_files/Noise.nk") + "\")")
expressionMenu.addCommand('Creations/Noise/fBm NST', "nuke.nodePaste(\"" + os.path.join(NST_FolderPath + "/nk_files/fBm.nk") + "\")")
expressionMenu.addCommand('Creations/Noise/Turbulence NST', "nuke.nodePaste(\"" + os.path.join(NST_FolderPath + "/nk_files/turbulence.nk") + "\")")
expressionMenu.addCommand('Creations/lines vertical NST', "nuke.nodePaste(\"" + os.path.join(NST_FolderPath + "/nk_files/Lines_Vertical.nk") + "\")")
expressionMenu.addCommand('Creations/lines horizontal NST', "nuke.nodePaste(\"" + os.path.join(NST_FolderPath + "/nk_files/Lines_Horizontal.nk") + "\")")
expressionMenu.addCommand('Creations/lines vertical animated NST', "nuke.nodePaste(\"" + os.path.join(NST_FolderPath + "/nk_files/Lines_Vertical_Animated.nk") + "\")")
expressionMenu.addCommand('Creations/lines horizontal animated NST', "nuke.nodePaste(\"" + os.path.join(NST_FolderPath + "/nk_files/Lines_Horizontal_Animated.nk") + "\")")
expressionMenu.addCommand('Creations/circles NST', "nuke.nodePaste(\"" + os.path.join(NST_FolderPath + "/nk_files/circles.nk") + "\")")
expressionMenu.addCommand('Creations/circles user NST', "nuke.nodePaste(\"" + os.path.join(NST_FolderPath + "/nk_files/circles_user.nk") + "\")")
expressionMenu.addCommand('Creations/points NST', "nuke.nodePaste(\"" + os.path.join(NST_FolderPath + "/nk_files/points.nk") + "\")")
expressionMenu.addCommand('Creations/points advanced NST', "nuke.nodePaste(\"" + os.path.join(NST_FolderPath + "/nk_files/points_advanced.nk") + "\")")
expressionMenu.addCommand('Creations/bricks NST', "nuke.nodePaste(\"" + os.path.join(NST_FolderPath + "/nk_files/bricks.nk") + "\")")
expressionMenu.addCommand('Creations/gradient horizontal NST', "nuke.nodePaste(\"" + os.path.join(NST_FolderPath + "/nk_files/gradient_horizontal.nk") + "\")")
expressionMenu.addCommand('Creations/gradient horizontal invert NST', "nuke.nodePaste(\"" + os.path.join(NST_FolderPath + "/nk_files/gradient_horizontal_invert.nk") + "\")")
expressionMenu.addCommand('Creations/gradient vertical NST', "nuke.nodePaste(\"" + os.path.join(NST_FolderPath + "/nk_files/gradient_vertical.nk") + "\")")
expressionMenu.addCommand('Creations/gradient vertical invert NST', "nuke.nodePaste(\"" + os.path.join(NST_FolderPath + "/nk_files/gradient_vertical_invert.nk") + "\")")
expressionMenu.addCommand('Creations/gradient 4 corners NST', "nuke.nodePaste(\"" + os.path.join(NST_FolderPath + "/nk_files/GradientCorner.nk") + "\")")
expressionMenu.addCommand('Creations/radial NST', "nuke.nodePaste(\"" + os.path.join(NST_FolderPath + "/nk_files/radial.nk") + "\")")
expressionMenu.addCommand('Creations/radial gradient NST', "nuke.nodePaste(\"" + os.path.join(NST_FolderPath + "/nk_files/radial_gradient.nk") + "\")")
expressionMenu.addCommand('Creations/radial rays NST', "nuke.nodePaste(\"" + os.path.join(NST_FolderPath + "/nk_files/radial_rays.nk") + "\")")
expressionMenu.addCommand('Creations/Trunc NST', "nuke.nodePaste(\"" + os.path.join(NST_FolderPath + "/nk_files/Trunc.nk") + "\")")

#ALPHA
expressionMenu.addCommand('Alpha/alpha binary NST', "nuke.nodePaste(\"" + os.path.join(NST_FolderPath + "/nk_files/alpha_binary.nk") + "\")")
expressionMenu.addCommand('Alpha/alpha comparison NST', "nuke.nodePaste(\"" + os.path.join(NST_FolderPath + "/nk_files/alpha_comparison.nk") + "\")")
expressionMenu.addCommand('Alpha/alpha exists? NST', "nuke.nodePaste(\"" + os.path.join(NST_FolderPath + "/nk_files/alpha_exists.nk") + "\")")
expressionMenu.addCommand('Alpha/alpha sum NST', "nuke.nodePaste(\"" + os.path.join(NST_FolderPath + "/nk_files/alpha_sum.nk") + "\")")

#PIXEL
expressionMenu.addCommand('Pixel/absolute value NST', "nuke.nodePaste(\"" + os.path.join(NST_FolderPath + "/nk_files/abs.nk") + "\")")
expressionMenu.addCommand('Pixel/check negative NST', "nuke.nodePaste(\"" + os.path.join(NST_FolderPath + "/nk_files/check_negative.nk") + "\")")
expressionMenu.addCommand('Pixel/check nan inf pixels NST', "nuke.nodePaste(\"" + os.path.join(NST_FolderPath + "/nk_files/check_nan_inf.nk") + "\")")
expressionMenu.addCommand('Pixel/create nan pixel NST', "nuke.nodePaste(\"" + os.path.join(NST_FolderPath + "/nk_files/create_nan.nk") + "\")")
expressionMenu.addCommand('Pixel/kill nan pixel NST', "nuke.nodePaste(\"" + os.path.join(NST_FolderPath + "/nk_files/kill_nan.nk") + "\")")
expressionMenu.addCommand('Pixel/create inf pixel NST', "nuke.nodePaste(\"" + os.path.join(NST_FolderPath + "/nk_files/create_inf.nk") + "\")")
expressionMenu.addCommand('Pixel/kill inf pixel NST', "nuke.nodePaste(\"" + os.path.join(NST_FolderPath + "/nk_files/kill_inf.nk") + "\")")

#TRANSFORM
expressionMenu.addCommand('Transform/Coordinates NST', "nuke.nodePaste(\"" + os.path.join(NST_FolderPath + "/nk_files/coordinates.nk") + "\")")
expressionMenu.addCommand('Transform/UV to Vector NST', "nuke.nodePaste(\"" + os.path.join(NST_FolderPath + "/nk_files/UV_to_Vector.nk") + "\")")
expressionMenu.addCommand('Transform/Vector to UV NST', "nuke.nodePaste(\"" + os.path.join(NST_FolderPath + "/nk_files/Vector_to_UV.nk") + "\")")
expressionMenu.addCommand('Transform/transform NST', "nuke.nodePaste(\"" + os.path.join(NST_FolderPath + "/nk_files/transform.nk") + "\")")
expressionMenu.addCommand('Transform/transform advanced NST', "nuke.nodePaste(\"" + os.path.join(NST_FolderPath + "/nk_files/transform_advanced.nk") + "\")")
expressionMenu.addCommand('Transform/twist NST', "nuke.nodePaste(\"" + os.path.join(NST_FolderPath + "/nk_files/twist.nk") + "\")")
expressionMenu.addCommand('Transform/STMap_invert NST', "nuke.nodePaste(\"" + os.path.join(NST_FolderPath + "/nk_files/STMap_invert.nk") + "\")")

#3D and DEEP
expressionMenu.addCommand('3D and Deep/Normal Pass - Relight NST', "nuke.nodePaste(\"" + os.path.join(NST_FolderPath + "/nk_files/normalPass_relight.nk") + "\")")
expressionMenu.addCommand('3D and Deep/C4x4 NST', "nuke.nodePaste(\"" + os.path.join(NST_FolderPath + "/nk_files/C4x4.nk") + "\")")
expressionMenu.addCommand('3D and Deep/Deep Thickness NST', "nuke.nodePaste(\"" + os.path.join(NST_FolderPath + "/nk_files/deepThickness.nk") + "\")")
expressionMenu.addCommand('3D and Deep/Deep to Depth NST', "nuke.nodePaste(\"" + os.path.join(NST_FolderPath + "/nk_files/deepToDepth.nk") + "\")")
expressionMenu.addCommand('3D and Deep/Depth normalize NST', "nuke.nodePaste(\"" + os.path.join(NST_FolderPath + "/nk_files/depth_normalize.nk") + "\")")

#KEYING and DESPILL
expressionMenu.addCommand('Keying and Despill/despill green NST', "nuke.nodePaste(\"" + os.path.join(NST_FolderPath + "/nk_files/despill_green.nk") + "\")")
expressionMenu.addCommand('Keying and Despill/despill green list NST', "nuke.nodePaste(\"" + os.path.join(NST_FolderPath + "/nk_files/despill_green_list.nk") + "\")")
expressionMenu.addCommand('Keying and Despill/despill blue NST', "nuke.nodePaste(\"" + os.path.join(NST_FolderPath + "/nk_files/despill_blue.nk") + "\")")
expressionMenu.addCommand('Keying and Despill/despill blue list NST', "nuke.nodePaste(\"" + os.path.join(NST_FolderPath + "/nk_files/despill_blue_list.nk") + "\")")
expressionMenu.addCommand('Keying and Despill/keying NST', "nuke.nodePaste(\"" + os.path.join(NST_FolderPath + "/nk_files/keying.nk") + "\")")
expressionMenu.addCommand('Keying and Despill/differenceKey NST', "nuke.nodePaste(\"" + os.path.join(NST_FolderPath + "/nk_files/differenceKey.nk") + "\")")
expressionMenu.addCommand('Keying and Despill/IBKGizmo_Expression NST', "nuke.nodePaste(\"" + os.path.join(NST_FolderPath + "/nk_files/IBKGizmo_Expression.nk") + "\")")
...
VMT_mathAxisMenu.addCommand('Invert Axis NST', "nuke.createNode('{}InvertAxis')".format(prefixNST), icon = 'Axis.png')
VMT_mathAxisMenu.addCommand('Zero Axis NST', "nuke.createNode('{}ZeroAxis')".format(prefixNST), icon = 'Axis.png')

VMT_mathMatrixFourMenu.addCommand('Invert Matrix4 NST', "nuke.createNode('{}InvertMatrix4')".format(prefixNST), icon = 'InvertMatrix4.png')
VMT_mathMatrixFourMenu.addCommand('Product Matrix4 NST', "nuke.createNode('{}ProductMatrix4')".format(prefixNST), icon = 'ProductMatrix4.png')
VMT_mathMatrixFourMenu.addCommand('Rotate Matrix4 NST', "nuke.createNode('{}RotateMatrix4')".format(prefixNST), icon = 'RotateMatrix4.png')
VMT_mathMatrixFourMenu.addCommand('Scale Matrix4 NST', "nuke.createNode('{}ScaleMatrix4')".format(prefixNST), icon = 'ScaleMatrix4.png')
VMT_mathMatrixFourMenu.addCommand('Transform Matrix4 NST', "nuke.createNode('{}TransformMatrix4')".format(prefixNST), icon = 'TransformMatrix4.png')
VMT_mathMatrixFourMenu.addCommand('Translate Matrix4 NST', "nuke.createNode('{}TranslateMatrix4')".format(prefixNST), icon = 'TranslateMatrix4.png')
VMT_mathMatrixFourMenu.addCommand('Transpose Matrix4 NST', "nuke.createNode('{}TransposeMatrix4')".format(prefixNST), icon = 'TransposeMatrix4.png')

VMT_mathVectorTwoMenu.addCommand('Cross Product Vector2 NST', "nuke.createNode('{}CrossProductVector2')".format(prefixNST), icon = 'CrossProductVector3.png')
VMT_mathVectorTwoMenu.addCommand('Dot Product Vector2 NST', "nuke.createNode('{}DotProductVector2')".format(prefixNST), icon = 'DotProductVector3.png')
VMT_mathVectorTwoMenu.addCommand('Magnitude Vector2 NST', "nuke.createNode('{}MagnitudeVector2')".format(prefixNST), icon = 'MagnitudeVector3.png')
VMT_mathVectorTwoMenu.addCommand('Normalize Vector2 NST', "nuke.createNode('{}NormalizeVector2')".format(prefixNST), icon = 'NormalizeVector3.png')
VMT_mathVectorTwoMenu.addCommand('Rotate Vector2 NST', "nuke.createNode('{}RotateVector2')".format(prefixNST), icon = 'RotateVector3.png')
VMT_mathVectorTwoMenu.addCommand('Transform Vector2 NST', "nuke.createNode('{}TransformVector2')".format(prefixNST), icon = 'TransformVector3.png')

VMT_mathVectorThreeMenu.addCommand('Cross Product Vector3 NST', "nuke.createNode('{}CrossProductVector3')".format(prefixNST), icon = 'CrossProductVector3.png')
VMT_mathVectorThreeMenu.addCommand('Dot Product Vector3 NST', "nuke.createNode('{}DotProductVector3')".format(prefixNST), icon = 'DotProductVector3.png')
VMT_mathVectorThreeMenu.addCommand('Magnitude Vector3 NST', "nuke.createNode('{}MagnitudeVector3')".format(prefixNST), icon = 'MagnitudeVector3.png')
VMT_mathVectorThreeMenu.addCommand('Multiply Vector3 Matrix3 NST', "nuke.createNode('{}MultiplyVector3Matrix3')".format(prefixNST), icon = 'ProductVector3.png')
VMT_mathVectorThreeMenu.addCommand('Normalize Vector3 NST', "nuke.createNode('{}NormalizeVector3')".format(prefixNST), icon = 'NormalizeVector3.png')
VMT_mathVectorThreeMenu.addCommand('Rotate Vector3 NST', "nuke.createNode('{}RotateVector3')".format(prefixNST), icon = 'RotateVector3.png')
VMT_mathVectorThreeMenu.addCommand('Transform Vector3 NST', "nuke.createNode('{}TransformVector3')".format(prefixNST), icon = 'TransformVector3.png')

VMT_generateMenu = VMTmenu.addMenu('Generate', icon = 'IdentityMatrix4.png')
VMT_generateMenu.addCommand('Generate Matrix4 NST', "nuke.createNode('{}GenerateMatrix4')".format(prefixNST), icon = 'IdentityMatrix4.png')
VMT_generateMenu.addCommand('Generate STMap NST', "nuke.createNode('{}GenerateSTMap')".format(prefixNST), icon = 'AG_UVMap.png')

VMT_convertMenu = VMTmenu.addMenu('Convert', icon = 'ProductVector3.png')
VMT_convertMenu.addCommand('Luma To Vector3 NST', "nuke.createNode('{}LumaToVector3')".format(prefixNST), icon = 'vectorToolsBW.png')
VMT_convertMenu.addCommand('STMap To Vector2 NST', "nuke.createNode('{}STMapToVector2')".format(prefixNST), icon = 'Vector2.png')
VMT_convertMenu.addCommand('Vector2 To STMap NST', "nuke.createNode('{}Vector2ToSTMap')".format(prefixNST), icon = 'AG_UVMap.png')
VMT_convertMenu.addCommand('Vector3 To Matrix4 NST', "nuke.createNode('{}Vector3ToMatrix4')".format(prefixNST), icon = 'ProductVector3.png')
